...
int main() {
    ...
    cout << "Canal azul original (b): " << bitset<8>(b) << " (" << (int)b << ")" << endl;
    cout << "Canal verde original (b): " << bitset<8>(g) << " (" << (int)g << ")" << endl;

    unsigned char b_rotado = rotarIzquierda(b);
    unsigned char g_rotado = rotarIzquierda(g);

    cout << "b rotado izquierda: " << bitset<8>(b_rotado) << endl;
    cout << "g rotado izquierda: " << bitset<8>(g_rotado) << endl;

    unsigned char b_recuperado = rotarDerecha(b_rotado);
    unsigned char g_recuperado = rotarDerecha(g_rotado);

    cout << "b recuperado: " << bitset<8>(b_recuperado) << " (" << (int)b_recuperado << ")" << endl;
    cout << "g recuperado: " << bitset<8>(g_recuperado) << " (" << (int)g_recuperado << ")" << endl;
